...
const sendTransaction_1 = require("../../../lib/commonjs/networks/xrp/sendTransaction");
...
(0, globals_1.describe)('networksXRP', () => {
    ...
    (0, globals_1.test)('getBalance', async () => {
        ...
        (0, globals_1.expect)(balanceResult.balance).toBe('20548073');
    });
    (0, globals_1.test)('sendTransaction', async () => {
        ...
        const rawTransaction = await (0, builder_1.buildTransaction)({
            from: publicAddress,
            to: 'raCRsF2Lv6xRcAxTJq55x21ms2TUNrRCCJ',
            amount: '10',
            keyPair,
        ...
        const result = await (0, sendTransaction_1.sendTransaction)({
            rawTransaction,
            connector: utils_1.apiRipple,
        });
